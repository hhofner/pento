defmodule PentoWeb.QuestionLiveTest do
  ...
  @create_attrs %{answer: "some answer", title: "some title", upvotes: 42}
  @update_attrs %{answer: "some updated answer", title: "some updated title", upvotes: 43}
  @invalid_attrs %{answer: nil, title: nil, upvotes: nil}
